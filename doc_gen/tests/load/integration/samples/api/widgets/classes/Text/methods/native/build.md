...
If a widget's [build](flutter-docs://api/widgets/Text/build) method is to depend on anything else, use a [StatefulWidget](flutter-docs://api/widgets/StatefulWidget) instead.
