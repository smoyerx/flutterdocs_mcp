...
This example shows best practices for implementing [debugFillProperties](mcp://flutter/api/material/MaterialStateMixin/debugFillProperties) illustrating use of all common [DiagnosticsProperty](mcp://flutter/api/foundation/DiagnosticsProperty) subclasses and all
...
Used by [toDiagnosticsNode](mcp://flutter/api/material/MaterialStateMixin/toDiagnosticsNode) and [toString](mcp://flutter/api/material/MaterialStateMixin/toString).
