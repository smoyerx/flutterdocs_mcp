...
[ThemeData](mcp://flutter/api/material/ThemeData) lerp(
[ThemeData](mcp://flutter/api/material/ThemeData) a,
[ThemeData](mcp://flutter/api/material/ThemeData) b,
[double](mcp://flutter/api/dart-core/double) t
)
...
easily be generated by curves such as [Curves.elasticInOut](mcp://flutter/api/animation/Curves/elasticInOut)).

Values for `t` are usually obtained from an [Animation<double>](mcp://flutter/api/animation/Animation), such as
an [AnimationController](mcp://flutter/api/animation/AnimationController).
