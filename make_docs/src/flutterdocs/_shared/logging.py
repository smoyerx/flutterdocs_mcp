"""Shared logging utilities for flutterdocs tools.

This module provides centralized logging configuration and utilities
for all flutterdocs tools (convert, load, etc.).
"""
...
_PROGRESS_LOGGER_NAME = "flutterdocs.progress"
_NOTIFICATION_LOGGER_NAME = "flutterdocs.notification"
...
def configure_logging(verbose: bool) -> None:
    """Configure logging for flutterdocs tools.
    ...
    Examples:
        ...
        $ tool --verbose 2>&1 | grep "\\[flutterdocs.notification\\]"

        # Filter to only progress messages
        $ tool --verbose 2>&1 | grep "\\[flutterdocs.progress\\]"
    """
