...
This example shows best practices for implementing [debugFillProperties](flutter-docs://api/material/MaterialStateMixin/debugFillProperties) illustrating use of all common [DiagnosticsProperty](flutter-docs://api/foundation/DiagnosticsProperty) subclasses and all
...
Used by [toDiagnosticsNode](flutter-docs://api/material/MaterialStateMixin/toDiagnosticsNode) and [toString](flutter-docs://api/material/MaterialStateMixin/toString).
