...
This example shows best practices for implementing [debugFillProperties](flutter-docs://api/material/ThemeData/debugFillProperties) illustrating use of all common [DiagnosticsProperty](flutter-docs://api/foundation/DiagnosticsProperty) subclasses and all
...
Used by [toDiagnosticsNode](flutter-docs://api/foundation/Diagnosticable/toDiagnosticsNode) and [toString](flutter-docs://api/foundation/Diagnosticable/toString).
